...
export function buildHeader(activePage = '') {
    ...
    const navLinks = [
        ...
        { label: 'Catalogue', href: authed ? p + 'catalogue.html' : p + 'index.html', key: 'catalogue' },
        { label: authed ? 'Mes commandes' : 'Produits', href: authed ? p + 'commandes.html' : p + 'index.html', key: 'commandes' },
        { label: authed ? 'Wallet' : 'À propos', href: authed ? p + 'wallet.html' : p + 'index.html', key: 'wallet' },
    ];
